...
const Login = ({ setLoginUser}) => {
    ...
    return (
        <div className="login">
            <br/>
            <br/>
            <h1>AUTO MOBILE MANAGEMENT SYSTEM LOGIN</h1>
            <br/>
            <br/>
            ...
            <Button variant="contained" color="success" className="button" onClick={login}>Login</Button>
            <div>or</div>
            <Button variant="contained" color="success" className="button" onClick={() => history.push("/register")}>Register</Button>
            </FormControl>
        </div>
    )
}
